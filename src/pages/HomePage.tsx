...
const faqItems = [
  ...
  {
    q: 'Возможна ли интеграция с нашей ERP-системой?',
    a: 'Платформа готовится к интеграции с 1С и другими ERP-системами. Обсудите с нашим менеджером технические возможности.',
  },
];
