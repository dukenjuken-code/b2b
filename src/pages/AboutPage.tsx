...
const timeline = [
  { year: '2010', event: 'Основание производства в структуре ОАО «Смолевичи Бройлер»' },
  { year: '2014', event: 'Запуск линейки СервоЛайн для промышленных предприятий' },
  { year: '2017', event: 'Выход на внешний B2B-рынок: HoReCa, пищевая промышленность' },
  ...
  { year: '2024', event: 'Цифровая платформа и развитие B2B e-commerce направления' },
];
